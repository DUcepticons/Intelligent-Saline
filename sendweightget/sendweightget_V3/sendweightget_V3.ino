...
void loop() {
 ...
 //GET Data
  ...
  payload = http.getString();    //Get the response payload  //returns two digit value(ex. 50/51/60/61) First value for mute button(6=mute pressed, 5= default), 2nd value for saline on/off button(1=ON, 0=OFF)
